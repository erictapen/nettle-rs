...
pub const SHA1_DIGEST_SIZE: usize = ::nettle_sys::SHA1_DIGEST_SIZE as usize;
...
impl Default for Sha1 {
    fn default() -> Self {
        ...
        unsafe { nettle_sha1_init(&mut ctx as *mut _); }
...
impl Sha1 {
    pub fn update(&mut self, data: &[u8]) {
        unsafe {
            nettle_sha1_update(&mut self.context as *mut _, data.len(), data.as_ptr());
        }
    }
