...
impl Default for Sha512_224 {
    fn default() -> Self {
        ...
        unsafe { nettle_sha512_224_init(&mut ctx as *mut _); }
...
impl Hash for Sha512_224 {
    fn digest_size(&self) -> usize { ::nettle_sys::SHA512_224_DIGEST_SIZE as usize }
...
mod tests {
    ...
    fn nist_cavs_short_msg() {
        ...
        ctx.update(b"\x32\xd0\x49\x92\x8a\x58\x3b\x5b\x95\x47\x85\x80\x5d\x8b\x26");
        ctx.digest(&mut digest);
        ...
        ctx.update(b"\x3b\x25\x42\xcb\x3f\xa5\x60\xdd\x0d\x79\x6d\x59\xee\x15\x1f\xee");
        ctx.digest(&mut digest);
